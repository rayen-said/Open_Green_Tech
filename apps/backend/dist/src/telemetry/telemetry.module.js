...
exports.TelemetryModule = TelemetryModule = __decorate([
    (0, common_1.Module)({
        providers: [telemetry_service_1.TelemetryService, telemetry_gateway_1.TelemetryGateway],
        controllers: [telemetry_controller_1.TelemetryController],
        exports: [telemetry_service_1.TelemetryService, telemetry_gateway_1.TelemetryGateway],
    })
], TelemetryModule);
